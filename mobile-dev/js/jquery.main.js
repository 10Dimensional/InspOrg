...
function initValidation() {
	...
	jQuery('form.signup-form').each(function(){
		var form = jQuery(this).attr('novalidate', 'novalidate'),
			successFlag = true,
			inputs = form.find('input:text, input[type="email"]');
		...
		function setState(field, error) {
			...
			if(error) {
				field.addClass(errorClass).one('focus',function(){field.removeClass(errorClass);});
				successFlag = false;
			}
		}
