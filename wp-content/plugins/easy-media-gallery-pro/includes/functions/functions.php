...
function easymedia_frontend_js() {
	...
	wp_register_script( 'easymedia-jpages', plugins_url( 'js/jquery/jPages.js' , dirname(__FILE__) ) );		
	wp_register_script( 'easymedia-lazyload', plugins_url( 'js/jquery/jquery.lazyload.min.js' , dirname(__FILE__) ) );
}
