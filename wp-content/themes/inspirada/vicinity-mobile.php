...
<?php the_breadcrumb(); ?>
			...
			<h1 class="page-title">
				...
				<span class="text" style="font:16px 'arimoregular', Helvetica, sans-serif; padding-top: 56px;"><?php the_field('paragraph'); ?></span>
			</h1>
			
			<section class="vicinity-section" style="margin-top: 160px;">
			<div class="row">
			<div class="col-xs-12">
                <div class="panel" style="position: realative; z-index: 1000; margin-top: 10px; margin-left: 10px;">
                    <section>
 ...
 <div class="accordion-group">
  ...
  <style>
    ...
    #map { position: relative; z-index: 1; margin-top: 20px; top:0; bottom:0; width: 760px; height: 1060px; }
    #sidebar-vicinity { float: none; width: 250px; margin: 0 auto; padding-bottom: 20px; padding-left: 0px;}
    @media only screen 
and (min-device-width : 768px) 
and (max-device-width : 1024px) 
and (orientation : portrait) {
    #map { position: relative; z-index: 1; margin-top: 20px; top:0; bottom:0; width: 515px; height: 1060px; }
}
  </style>
</head>
<body>
