<?php
                ...
                */ 
                ...
                $where_clause = 'WHERE builder = "Pardee Homes" AND price_min >= '.$price_min.' AND price_max <= '.$price_max.' AND beds_max >= '.$beds.' AND sq_ft >= '.$sq_ft;    
...
<?php 
    echo do_shortcode("[metaslider id=843]"); 
?>						</div>
		<nav>
		...
		<h1 class="page-title page-title-1" style="padding:0;">
			<a href="http://www.pardeehomes.com/" target="_blank"><img src="<?php bloginfo('template_url') ?>/images/pardee-for-builders.png"></a>
		</h1>
	</div>
