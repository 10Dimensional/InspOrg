...
?>	</div>
			<div class="intro-section">
				<div class="heading">
					<a href="/community" class="btn-explore">EXPLORE INSPIRADA</a>
			...
			<section class="features-section">
				...
				<ul class="buttons-list">
					...
					<li class="style-1"><a href="/community"><div class="btn-bg"></div><span><?php the_field('hex2'); ?></span></a></li>
					<li class="style-2"><a href="/location-area"><div class="btn-bg"></div><span><?php the_field('hex3'); ?></span></a></li>
				</ul>
			</section>
		</div>
	</div>
